<html>
    ...
    <body>
        ...
        <table class="table2">
            <tr>
                <th class="th2">QUẢN LÝ DANH MỤC</th>
                <th class="th3"><button class="btn btn-outline-info mt-1 mr-1" style="width:150px; height: 40px;"><a href="/taodanhmuc" style=" text-decoration: none; font-size: 15px;">Tạo danh mục</a></button></th>
            </tr>
        </table>
        <div class="table3">
            <form action="">
