            ...
            <form action="">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-sm-9">
                            <input type="text" class="form-control" name="sdt" id="sdt1" required>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-3">
                            <button class="btn btn-outline mt-1 mr-1" style="width:90px; height: 40px; float: left; background-color: lightpink;"><a href="./quanlydanhmuc" style="text-decoration: none; font-size: 15px; color: white;">Quay lại</a></button>
                        </div>
                        <div class="col-md-9 col-sm-9">
